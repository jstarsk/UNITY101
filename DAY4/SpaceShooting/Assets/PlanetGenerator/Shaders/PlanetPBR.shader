...
Shader "Human Unit/PlanetPBR" {
    Properties {
        ...
        _Temperature ("Temperature", Range(0, 1)) = 0.6601942
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_4778 = mul( unity_WorldToObject, float4(normals,0) ).xyz;
                float3 node_9531 = (node_4778.rgb*1.4);
                float3 node_8769 = normalize((node_9531*node_9531*node_9531*node_9531));
                float3 node_2711 = node_8769.rgb;
                float3 node_7084 = ((node_8769/(node_2711.r+node_2711.g+node_2711.b))*1.0);
                float node_1511 = (_Size*5.8+0.2);
                float randomSeed = _RandomSeed;
                float node_4526 = randomSeed;
                float node_2737_ang = node_4526;
                float node_2737_spd = 1.0;
                float node_2737_cos = cos(node_2737_spd*node_2737_ang);
                float node_2737_sin = sin(node_2737_spd*node_2737_ang);
                float2 node_2737_piv = float2(0.5,0.5);
                float3 node_4530 = mul( unity_WorldToObject, float4((i.posWorld.rgb-objPos.rgb),0) ).xyz.rgb.rgb;
                float2 node_9780 = (float2(node_4530.g,node_4530.b)*0.5+0.5);
                float2 node_2737 = (mul(node_9780-node_2737_piv,float2x2( node_2737_cos, -node_2737_sin, node_2737_sin, node_2737_cos))+node_2737_piv);
                float2 node_3185 = (node_1511*(node_2737+node_4526*float2(1,1)));
                ...
                float node_7942 = (randomSeed+50.0);
                float node_7128_ang = node_7942;
                float node_7128_spd = 1.0;
                float node_7128_cos = cos(node_7128_spd*node_7128_ang);
                float node_7128_sin = sin(node_7128_spd*node_7128_ang);
                float2 node_7128_piv = float2(0.5,0.5);
                float2 node_7128 = (mul((float2(node_4530.b,node_4530.r)*0.5+0.5)-node_7128_piv,float2x2( node_7128_cos, -node_7128_sin, node_7128_sin, node_7128_cos))+node_7128_piv);
                float2 node_8168 = (node_1511*(node_7128+node_7942*float2(0,1)));
                float4 _node_4104 = tex2D(_CracksMap,TRANSFORM_TEX(node_8168, _CracksMap));
                float node_2723 = (randomSeed+100.0);
                float node_9102_ang = node_2723;
                float node_9102_spd = 1.0;
                float node_9102_cos = cos(node_9102_spd*node_9102_ang);
                float node_9102_sin = sin(node_9102_spd*node_9102_ang);
                float2 node_9102_piv = float2(0.5,0.5);
                float2 node_1534 = (float2(node_4530.r,node_4530.g)*0.5+0.5);
                float2 node_9102 = (mul(node_1534-node_9102_piv,float2x2( node_9102_cos, -node_9102_sin, node_9102_sin, node_9102_cos))+node_9102_piv);
                float2 node_6078 = (node_1511*(node_9102+node_2723*float2(0,1)));
                float4 _node_4711 = tex2D(_CracksMap,TRANSFORM_TEX(node_6078, _CracksMap));
                float node_4899 = (1.0 - _Cracks);
                float node_6503 = 0.0;
                float cracks = saturate((node_6503 + ( ((node_7084.r*_node_5412.r + node_7084.g*_node_4104.r + node_7084.b*_node_4711.r) - node_4899) * (1.0 - node_6503) ) / (1.0 - node_4899)));
                ...
                float node_9755 = min((1.0 - saturate((cracks*_CracksDepth*1.5))),(node_7084.r*_node_4032.r + node_7084.g*_node_4033.r + node_7084.b*_node_9119.r));
                ...
                float4 node_3788 = _Time + _TimeEditor;
                float node_618 = (node_3788.g*_CloudsSpeed*3.0);
                ...
                float3 node_2727 = abs(node_4778.rgb);
                ...
                float3 node_4465 = normalize(node_4778.rgb).rgb;
                ...
                float3 normalDirection = lerp(i.normalDir,lerp(normalize(mul( unity_ObjectToWorld, float4((node_7084.r*normX( Rotate( lerp(lerp(_node_8302.rgb,(lerp(_node_4299.rgb,_node_4299.rgb.grb,node_8775)*node_6794*node_5082*node_1691),cracks),ClR,node_4880) , node_4526 , node_4465.r , node_4465.g ) , node_4465 ) + node_7084.g*normYX( Rotate2( lerp(lerp(_node_3569.rgb,(lerp(_node_4472.rgb,_node_4472.rgb.grb,node_8775)*node_6794*node_5082*node_1691),cracks),ClG,node_4880) , node_7942 , node_4465.g , node_4465.b , node_4465.r ) , node_4465 ) + node_7084.b*normXZ( Rotate3( lerp(lerp(_node_1291.rgb,(lerp(_node_2172.rgb,_node_2172.rgb.grb,node_8775)*node_6794*node_5082*node_1691),cracks),ClB,node_4880) , node_2723 , node_4465.b , node_4465.g ) , node_6399 , node_4465 )),0) ).xyz.rgb),i.normalDir,(Water*(1.0 - Clouds))),_NormalIntencity);
...
///////// Gloss:
                ...
                float perceptualRoughness = 1.0 - (Water*_Gloss*(1.0 - Clouds));
...
////// Specular:
                ...
                float size = node_1511;
                float node_9003 = (lightSide*(size*0.5+1.0));
                float node_4684 = saturate(lerp(node_9003,0.5,_Ambient));
                ...
                float3 specularColor = (node_4684*(max((0.3*node_7108),(Water*(1.0 - node_7108)))*_Specularity*node_3337*saturate((0.5+atmosphereColor)))).r;
                ...
                float node_2583 = (node_7084.r*node_1022.r + node_7084.g*node_7232.r + node_7084.b*node_8314.r);
                ...
                float3 diffuseColor = saturate((1.0-(1.0-lerp(saturate(min(node_5369,node_3069)),_CracksColor.rgb,node_2352))*(1.0-node_8639))); // Need this for specular when using metallic
...
/////// Diffuse:
                ...
                indirectDiffuse *= node_4684; // Diffuse AO
...
////// Emissive:
                ...
                float node_9987 = (node_7084.r*node_4485.r + node_7084.g*node_3302.r + node_7084.b*node_1275.r);
