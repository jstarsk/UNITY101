...
Shader "Human Unit/Ring" {
    Properties {
        ...
        _Coils ("Coils", Range(0, 2)) = 0
        _Details ("Details", 2D) = "white" {}
        _Brightness ("Brightness", Range(0, 7)) = 0
...
/////// Diffuse:
                ...
                float4 node_9277 = _Time + _TimeEditor;
                ...
                float node_2335 = (_node_6171.r*node_7034);
                float2 node_4079 = (0.05*(node_2335 - 0.5)*mul(tangentTransform, viewDirection).xy + (float2((3.0*node_274),((_Speed*node_9277.r)+(6.0*((atan2(node_6058.g,node_6058.r)/6.28318530718)+0.5))))*1.0));
                float4 _Details_var = tex2D(_Details,TRANSFORM_TEX(node_4079.rg, _Details));
                float node_4315 = lerp(((_Details_var.r*node_7034)*2.0+-1.0),node_2335,saturate((partZ*0.3+0.7)));
