...
////// Specular:
                ...
                float3 specularColor = (node_4684*(max((0.3*node_7108),(Water*(1.0 - node_7108)))*_Specularity*node_3337*saturate((0.5+atmosphereColor))));
